...
# npx slidev build --out "./dist/slides_github_copilot_deep_dive" --base "/slides_github_copilot_deep_dive/" "slides_github_copilot_deep_dive.md"
# npx slidev build --out "./dist/slides_github_copilot_getting_started" --base "/slides_github_copilot_getting_started/" "slides_github_copilot_getting_started.md"
